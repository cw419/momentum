...
export function useAppShellViewModels(
  ...
  const dashboard = buildDashboardViewModel({
    ...
    handleCreateChainForToday: domains.handleCreateChainForToday,
    ...
    handleCompleteGoalChain: domains.handleCompleteGoalChain,
    addUnits: domains.addUnits,
    removeUnits: domains.removeUnits,
    startPlanItem: domains.startPlanItem,
