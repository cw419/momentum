...
interface ChainCardDeleteDialogProps {
  chain: Chain | ChainTreeNode;
  onConfirm: () => void;
  onCancel: () => void;
}

export const ChainCardDeleteDialog: React.FC<ChainCardDeleteDialogProps> = React.memo(
  ({ chain, onConfirm, onCancel }) => {
...
ChainCardDeleteDialog.displayName = 'ChainCardDeleteDialog';
