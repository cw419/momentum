...
describe('PureDOMSlider 移动端优化', () => {
  ...
  it('应该处理值变化', () => {
    ...
    render(<PureDOMSlider {...defaultProps} onValueChange={onValueChange} />);
  ...
  it('应该处理禁用状态', () => {
    render(<PureDOMSlider {...defaultProps} disabled={true} />);
  ...
  it('应该在初始值改变时更新', () => {
    ...
    // 重新渲染时改变初始值
    rerender(<PureDOMSlider {...defaultProps} initialValue={75} />);
