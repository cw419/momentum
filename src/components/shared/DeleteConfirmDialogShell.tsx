    ...
    <Portal>
      <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-black/50 p-4">
        <div
          ...
          className="max-h-[calc(100vh-2rem)] w-full max-w-lg animate-scale-in overflow-y-auto rounded-3xl border border-gray-200/60 bg-white/95 p-8 shadow-2xl backdrop-blur-xl dark:border-slate-600/60 dark:bg-slate-800/95"
        >
