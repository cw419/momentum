  ...
  return (
    <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/10">
      <div className="flex items-center gap-3">
        <span className="text-white/70">RSIP 模式</span>
        <div className="group relative">
          <Info size={16} className="text-white/40 cursor-help" />
          <div className="absolute left-0 bottom-full mb-2 w-64 p-3 bg-gray-800 rounded-xl text-xs text-white/80 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 shadow-xl">
