...
// 重写规则创建方法，绕过可能的问题
export async function emergencyCreateRule(
  name: string,
...
// 重写规则使用方法
export async function emergencyUseRule(
  ruleId: string,
...
if (typeof window !== 'undefined') {
  ...
  setTimeout(() => {
    ...
    const focusModeElements = document.querySelectorAll(
      '[data-component="FocusMode"]',
    );
